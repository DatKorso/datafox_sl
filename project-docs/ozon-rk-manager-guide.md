...
| Предмет | `punta_table.wb_object` | Тип товара (Ботинки/Кроссовки/и т.д.) |
...
- Справочные данные Punta (`punta_table`) - опционально
...
### 4. Enrichment данными Punta
```sql
-- Получение справочных данных (первое вхождение)
WITH first_occurrences AS (
    SELECT wb_sku, gender, season, material, wb_object,
